...
$retry = 0;
//CHK Gate1
if(cCmd($msg['text'], ['/sa', '/Sa', '/sA', '/SA', '!sa', '!Sa', '!sA', '!SA', '.sa', '.SA', '.sA', '.Sa']) && $isPremiun){
...
output('sendMessage', [
'chat_id' => $chat['id'],
'text' => "𝙂𝙖𝙩𝙚𝙬𝙖𝙮 ".$gate." ♻️\n𝙁𝙤𝙧𝙢𝙖𝙩 -» <code>/sa cc|month|year|cvc</code>",
...
/*=====  site  ======*/
$site = "https://shopnicekicks.com/products/nice-kicks-premium-nkbn-gry-enamel-pin-beanie-grey-mens-hat-grey";
/*=====  1REQ  ======*/
$ch = curl_init();
