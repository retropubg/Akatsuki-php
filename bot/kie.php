...
$retry = 0;
//CHK Gate1
if(cCmd($msg['text'], ['/ki', '/Ki', '/kI', '/KI', '!ki', '!Ki', '!kI', '!KI', '.ki', '.KI', '.kI', '.Ki']) && $isPremiun){
...
output('sendMessage', [
'chat_id' => $chat['id'],
'text' => "𝙂𝙖𝙩𝙚𝙬𝙖𝙮 ".$gate." ♻️\n𝙁𝙤𝙧𝙢𝙖𝙩 -» <code>/ki cc|month|year|cvc</code>",
...
/*=====  site  ======*/
$site = "https://www.shoepalace.com/products/jimi-hendrix-x-sp-jhhs01-sp-x-jimi-hendrix-lava-lamp-mens-shorts-black-blue?variant=42022858555598";
/*=====  1REQ  ======*/
$ch = curl_init();
