...
$retry = 0;
//CHK Gate1
if(cCmd($msg['text'], ['/ky', '/KY', '/kY', '/KY', '!ky', '!Ky', '!kY', '!KY', '.ky', '.KY', '.kY', '.Ky']) && $isPremiun){
...
output('sendMessage', [
'chat_id' => $chat['id'],
'text' => "𝙂𝙖𝙩𝙚𝙬𝙖𝙮 ".$gate." ♻️\n𝙁𝙤𝙧𝙢𝙖𝙩 -» <code>/ky cc|month|year|cvc</code>",
...
/*=====  site  ======*/
$site = "https://www.wigyy.com/collections/best-sellers/products/top-knot-big-bun-energy-4";
/*=====  1REQ  ======*/
$ch = curl_init();
