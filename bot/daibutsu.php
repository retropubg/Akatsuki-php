...
$retry = 0;
//CHK Gate1
if(cCmd($msg['text'], ['/da', '/DA', '/dA', '/DA', '!da', '!Da', '!dA', '!DA', '.da', '.DA', '.dA', '.Da']) && $isPremiun){
...
output('sendMessage', [
'chat_id' => $chat['id'],
'text' => "𝙂𝙖𝙩𝙚𝙬𝙖𝙮 ".$gate." ♻️\n𝙁𝙤𝙧𝙢𝙖𝙩 -» <code>/da cc|month|year|cvc</code>",
...
/*=====  site  ======*/
$site = "https://us.blochworld.com/collections/accessories/products/bobby-pins-pack-blonde";
/*=====  1REQ  ======*/
$ch = curl_init();
